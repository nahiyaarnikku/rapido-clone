    ...
    <div className="home-container">
        ...
        <div className="col-lg-5 home-left text-center text-lg-start">
          <div className="px-4">
            ...
            <div className="d-flex gap-2 gap-md-5 my-4 justify-content-center align-items-center">
              <button className="home-btn" onClick={() => navigate("/customer-signup")}>
                Sign-up as Customer
              </button>
              <button className="home-btn" onClick={() => navigate("/CaptainSignup")}>
                Sign-up as Driver
              </button>
            </div>
          </div>
      ...
      <div className="our-impact-container">
        ...
        <div className="container-2">
          {[presence1, presence2, presence3, presence4].map((img, index) => (
            <div key={index} className="box-1">
              <div className="box">
                <img src={img} alt="presence-img" className="presence-img" loading="lazy" />
                <bold>{["25 M", "100+", "1 M+", "10 M+"][index]}</bold>
                <p>{["Downloads", "Cities", "Captains", "Customers"][index]}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="customer-feed-container mt-2 py-2">
        <div className="container-1 text-center">
          ...
          <Slider1 feedback={toggleActive1 === "Customers" ? homeFeedback : feedCaptains} />
        </div>
      </div>
      ...
      <div className="row know-us-container">
        <div className="col-lg-6 text-center py-3 py-lg-0">
          ...
          <p className="know-us-text mx-auto text-center text-lg-start ps-2">
            ...
            With highly reliable deliveries and a strong customer base, we are one of
            the fastest-growing networks in the country. Sign up as a Rapido Partner for on-time services.
          </p>
        </div>
